...
class MainFragment : BrowseSupportFragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        setOnItemViewSelectedListener { _, item, _, _ ->
            if (item is CardItem) {
                ...
                Log.d("MainFragment", "Selected card: ${item.title}")
            }
        }
    ...
    private fun setupUIElements() {
        brandColor = resources.getColor(R.color.default_background)
...
//data class CardItem(val title: String, val description: String, val imageUrl: String)
